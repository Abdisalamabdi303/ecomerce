...
import { braintreePaymentMethodHandler } from '@vendure/payments-plugin/package/braintree';
...
export const config: VendureConfig = {
    ...
    dbConnectionOptions: {
        ...
        synchronize: IS_DEV, // Enable synchronize in development mode
    ...
    plugins: [
        ...
        BraintreePlugin.init({
            ...
            // Enable storing customer payment methods
            storeCustomersInBraintree: true,
        }),
        MpesaPlugin.init({
            consumerKey: process.env.MPESA_CONSUMER_KEY || '',
            consumerSecret: process.env.MPESA_CONSUMER_SECRET || '',
            environment: (process.env.MPESA_ENVIRONMENT || 'sandbox') as 'sandbox' | 'live',
            shortCode: process.env.MPESA_SHORTCODE || '',
            passkey: process.env.MPESA_PASSKEY || '',
            shortCodeType: (process.env.MPESA_SHORTCODE_TYPE || 'paybill') as 'paybill' | 'till',
